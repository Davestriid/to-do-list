...
public class AgregarComentario extends javax.swing.JFrame {
    ...
    private List<Comentarios> listaDeComentarios;
        ...
        tablaComentarios.getColumnModel().getColumn(0).setMinWidth(0);
        tablaComentarios.getColumnModel().getColumn(0).setMaxWidth(0);
        tablaComentarios.getColumnModel().getColumn(0).setWidth(0);
    }
